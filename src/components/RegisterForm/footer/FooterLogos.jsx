...
export default function FooterLogos({ t }) {
  return (
    <div className="w-screen h-28 absolute left-0 bottom-0 bg-white text-black flex justify-center">
      <div className="px-[8] max-w-7xl mx-auto w-full flex flex-col justify-center gap-2">
