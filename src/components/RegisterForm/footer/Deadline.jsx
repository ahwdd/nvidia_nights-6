...
export default function Deadline() {
  ...
  return (
    <div className="flex bg-black text-white w-screen overflow-hidden items-center justify-center relative md:h-80 h-60">
      ...
      className="size-full max-w-6xl ltr:ml-40 rtl:mr-40 rtl:-scale-y-100 rtl:rotate-180 object-fill md:block hidden" />
      <Image src={NVDubai} alt="Museum of the futur in Dubai"
      className="size-full max-w-6xl ltr:ml-10 rtl:mr-10 rtl:-scale-y-100 rtl:rotate-180 object-fill md:hidden block" />
